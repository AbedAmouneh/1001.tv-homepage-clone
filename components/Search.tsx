...
const Search: React.FC = () => {
  ...
  return (
    <>
      <FaSearch className="text-white text-2xl cursor-pointer" onClick={toggleSearch} />
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-slate-900 z-40 m-0">
          ...
          <div className="relative w-full max-w-6xl mx-auto mt-16 p-4 flex items-center justify-center">
            <div className="flex items-center w-full">
              <div className="text-green-600 text-2xl cursor-pointer mr-4"
              ...
              <div className="relative w-full">
                ...
                />
                <FaSearch
                  className="text-white text-2xl cursor-pointer absolute top-1/2 right-4 transform -translate-y-1/2"
                />
              </div>
            </div>
          </div>
